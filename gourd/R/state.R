...
fit_dependent <- function(model_name, all, anchor_anchor, anchor_shrinkage, anchor_shrinkage_reference, anchor_concentration, baseline_concentration, hyperparameters, unit_mcmc_tuning, global_mcmc_tuning, validation_data_list) {
  all_ptr <- .Call(.all, all)
  .Call(.fit_dependent, model_name, all_ptr, anchor_anchor, anchor_shrinkage, anchor_shrinkage_reference, anchor_concentration, baseline_concentration, hyperparameters, unit_mcmc_tuning, global_mcmc_tuning, validation_data_list)
}
