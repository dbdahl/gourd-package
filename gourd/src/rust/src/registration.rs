...
#[roxido]
fn fit_hierarchical_model(all_ptr: Rval, n_updates: Rval, unit_mcmc_tuning: Rval, global_hyperparameters: Rval, global_mcmc_tuning: Rval, validation_data: Rval) -> Rval {
    Rval::nil()
}
...
extern "C" fn R_init_gourd_rust(info: *mut rbindings::DllInfo) {
    let mut call_routines = Vec::with_capacity(28);
    let mut _names: Vec<std::ffi::CString> = Vec::with_capacity(28);
